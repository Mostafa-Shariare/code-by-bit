        ...
        <img src={blob} alt="" className='blob_a blob3' />
            ...
            <div className='feedSection'>
                <div className='feedinfo'>
                    <p className="info">For Being <mark>Amazing</mark>.Let's Become a part of a amazing community <mark>Codo By Bit</mark>.You can even Tell your's <mark>Issue Related to Website for Improving the Site</mark></p>
                </div>
